...
public class Crc16 {
    ...
    public static int getCrc16(byte[] buff, int buffLen, int crcSeed) {
        int lo = crcSeed & 0x0ff;
        int hi = crcSeed >> 8 & 0x0ff;

        for (int i = 0; i < buffLen; i++) {
            int tmp = (lo ^ buff[i]) & 0x0ff;
            lo = hi ^ abCrcTbl2[tmp];
            hi = abCrcTbl1[tmp];
        }
        return lo + (hi << 8);
    ...
    private static final int[] abCrcTbl1 = { 0x000, 0x0C0, 0x0C1, 0x001, 0x0C3, 0x003, 0x002, 0x0C2, 0x0C6, 0x006,
    ...
    private static final int[] abCrcTbl2 = { 0x00, 0x0C1, 0x081, 0x40, 0x01, 0x0C0, 0x080, 0x41, 0x01, 0x0C0, 0x080,
